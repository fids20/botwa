...
const instagram = 'https://instagram.com/juusan_gogatsu.id'; 
const telegram = 'https://t.me/pidah'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/juusagogatsu_id';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@juusan_gogatsu.id')
